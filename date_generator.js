...
[
Array.from({length:31},(_,i)=>days[(s+i)%7]),
Array.from({length:l},(_,i)=>days[(s+i+31)%7]),
Array.from({length:31},(_,i)=>days[(s+l+i+31)%7]),
Array.from({length:30},(_,i)=>days[(s+l+i+31+31)%7]),
Array.from({length:31},(_,i)=>days[(s+l+i+31+31+30)%7]),
Array.from({length:30},(_,i)=>days[(s+l+i+31+31+30+31)%7]),
Array.from({length:31},(_,i)=>days[(s+l+i+31+31+30+31+30)%7]),
Array.from({length:31},(_,i)=>days[(s+l+i+31+31+30+31+30+31)%7]),
Array.from({length:30},(_,i)=>days[(s+l+i+31+31+30+31+30+31+31)%7]),
Array.from({length:31},(_,i)=>days[(s+l+i+31+31+30+31+30+31+31+30)%7]),
Array.from({length:30},(_,i)=>days[(s+l+i+31+31+30+31+30+31+31+30+31)%7]),
Array.from({length:31},(_,i)=>days[(s+l+i+31+31+30+31+30+31+31+30+31+30)%7])
];


(31+31+30+31+30+31+31+30+31+30)%7
